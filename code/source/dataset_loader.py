...
def get_dataset(dataset_name, target_folder="/home/dima/Документы/Diploma/code/datasets", datasets=DATASETS_CONFIG):
    ...
    return np.array([img]), gt, label_values, ignored_labels, rgb_bands, palette, num_of_bands
