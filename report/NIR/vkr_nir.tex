...
\usepackage{etoolbox}   % добавил для ноута, надо поменять, возможно.
...
\begin{center}
\Large \bf{Научно-исследовательская работа на тему: \\}
\end{center}
...
\noindent Студент \underline{ИУ9-82Б} \hfill \underline{\hspace{4cm}}\quad \underline{\hspace{15pt} Головкин Д. С. \hspace{15pt}}

\vspace{-2ex}
\noindent\hspace{9.5ex}\scriptsize{(Группа)}\normalsize\hspace{165pt}\hspace{2ex}\scriptsize{(Подпись, дата)}\normalsize\hspace{30pt}\hspace{6ex}\scriptsize{(Фамилия И.О.)}\normalsize

\bigskip

\noindent Руководитель ВКР \hfill \underline{\hspace{4cm}}\quad \underline{\hspace{13pt} Каганов Ю. Т. \hspace{13pt}}
...
НИР состоит из~\pageref{TotPages} страниц, содержит \totalsections{} раздела, \totaltables{} таблицы и \totalfigures{} рисунка.
...
\begin{equation}\label{eq:8}
    \frac{\partial \theta_i}{\partial t} = \omega + \frac{k_1}{n} \sum_{j = 1}^{n}\sin(\theta_j - \theta_i), \quad i \in J_1
\end{equation}
\begin{equation}\label{eq:9}
    \frac{\partial \theta_i}{\partial t} = \omega + \frac{k_2}{n} \sum_{j = 1}^{n}\sin(\theta_j - \theta_0), \quad i \in J_2
...
\end{enumerate}
В контексте нашей задачи генетический алгоритм обладает наиболее широкой областью применения, но проигрывает приведенным правилам и принципам в области обучения модулей ОНС. 
